...
#if APPTICS_SWIFT
@protocol PromotedAppsControllerDelegate;
...
#if APPTICS_SWIFT
<PromotedAppsControllerDelegate,PromotedAppsKitDelegate>
#endif
...
typedef void (^fgEngagementRequestSuccessBlock)(void);
@property (nonatomic) fgEngagementRequestSuccessBlock _Nullable fgEngagementRequestSuccessBlock;
...
typedef void (^fgNonFatalRequestSuccessBlock)(void);
@property (nonatomic) fgNonFatalRequestSuccessBlock _Nullable fgNonFatalRequestSuccessBlock;
...
- (void) trackSignUp:(NSString* _Nullable)userID groupId : (NSString*_Nullable)groupid showConsent : (BOOL) shouldShowConsent;

- (void) trackLogIn:(NSString* _Nullable)userID groupId : (NSString*_Nullable)groupid;

- (void) trackLogIn:(NSString* _Nullable)userID groupId : (NSString*_Nullable)groupid showConsent : (BOOL) shouldShowConsent;

- (void) trackLogOut:(NSString* _Nullable)userID groupId : (NSString*_Nullable)groupid;

- (void) trackLogOut:(NSString* _Nullable)userID groupId : (NSString*_Nullable)groupid withBaseDomain:(NSString*_Nonnull)BD;
...
- (void) setCurrentUser:(NSString* _Nullable)userID groupId : (NSString*_Nullable)groupid showConsent : (BOOL) shouldShowConsent;
...
- (void) requestForPIIAuthorization;

#if !TARGET_OS_OSX && !TARGET_OS_WATCH

- (void) openPIIManagerControllerWithNavigationController : (UINavigationController *_Nullable) _navigationController;
...
-(UIViewController*)getPromotionalAppsViewController:(NSString*)sectionHeader1 : (NSString*)sectionHeader2;

-(void)presentPromotionalAppsController : (NSString*) sectionHeader1 : (NSString*)sectionHeader2;
