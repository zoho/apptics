 ...
 *  Use these methods `ZALogVerbose`, `ZALogDebug`, `ZALogInfo`, `ZALogWarn`, `ZALogError` in your own application to log, isntead of NSLog.
 *  The above method does the same thing as NSLog.
 ...
 @param level ZALogLevel.
 */

+ (void) setLogLevel: (ZALogLevel) level;
